  ...
  const content = {
    en: {
      ...
      sections: [
        ...
        { h: "2. Use of Information", p: "You grant True Salvation Church the right to use the provided information and medical data (including video taken during prayer time) for ministerial review and use. This allows Apostle Charles and the prayer committee to understand your situation and pray effectively." },
    ...
    rw: {
      ...
      sections: [
        ...
        { h: "2. Ikoreshwa ry'Amakuru", p: "Uhesheje uburenganzira True Salvation Church bwo gukoresha imyirondoro, n'impapuro za muganga utanze kugira ngo Apostle Charles n'itsinda rishinzwe amasengesho basobanukirwe ikibazo cyawe bityo bagusengere neza." },
...
export function PrayerRequestForm() {
  ...
  const translations = {
    ...
    rw: {
      ...
      whatsappPlaceholder: "Andika nimero ukoresha kuri whatsapp",
      ...
      joiningOptions: ["Ku rusengero", "Kuri murandasi (Zoom)"],
      ...
      uploadPrivacy: "Impapuro zawe zibikirwa ibanga rikomeye.",
