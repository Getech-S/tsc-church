                    ...
                    <div className="lg:col-span-4">
                        <div className="bg-[#1F1F1F] rounded-[16px] p-8 flex flex-col gap-6 h-full border border-white/5">
                            ...
                            <a href="https://www.youtube.com/@truesalvation6136" target="_blank" className="text-white hover:text-[#F5BE41] transition-colors">
                                ...
                                <a href="https://whatsapp.com/channel/0029Vb6WTTkBVJl7PUUJpC41" target="_blank" className="text-white hover:text-[#F5BE41] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                ...
                                <a href="https://us06web.zoom.us/j/89648189740?pwd=Fkpabpwu9V0trqZTeagUKI2sA23h8I.1" target="_blank" className="text-white hover:text-[#F5BE41] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                        <path d="M13.5 5.5h-10a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2zM19 8.5l-3.5 2v3l3.5 2v-7z" />
                                    </svg>
                                </a>
                            </div>
                        </div>
