...
export function ContactContent() {
    // 1. State for form data (Kept exactly as requested)
    ...
    // 4. Handle Form Submission (Kept your logic and Access Key)
...
<div className="flex gap-4 mt-4">
    {/* YouTube */}
    <a 
        href="https://www.youtube.com/@truesalvation6136" 
        target="_blank" 
        rel="noopener noreferrer"
        className="w-11 h-11 rounded-full border border-orange-200 flex items-center justify-center text-[#E8751A] hover:bg-orange-50 transition-all duration-300 cursor-pointer"
    >
    ...
    {/* Instagram */}
    <a 
        href="https://www.instagram.com/truesalvationchurch/" 
        target="_blank" 
        rel="noopener noreferrer"
        className="w-11 h-11 rounded-full border border-orange-200 flex items-center justify-center text-[#E8751A] hover:bg-orange-50 transition-all duration-300 cursor-pointer"
    >
    ...
    {/* TikTok */}
    <a 
        href="https://www.tiktok.com/@truesalvationchurch" 
        target="_blank" 
        rel="noopener noreferrer"
        className="w-11 h-11 rounded-full border border-orange-200 flex items-center justify-center text-[#E8751A] hover:bg-orange-50 transition-all duration-300 cursor-pointer"
    >
    ...
    {/* WhatsApp Channel */}
    <a 
        href="https://whatsapp.com/channel/0029Vb6WTTkBVJl7PUUJpC41" 
        target="_blank" 
        rel="noopener noreferrer"
        className="w-11 h-11 rounded-full border border-orange-200 flex items-center justify-center text-[#E8751A] hover:bg-orange-50 transition-all duration-300 cursor-pointer"
    >
    ...
    {/* X */}
    <a 
        href="https://x.com/truesalvationc?s=20" 
        target="_blank" 
        rel="noopener noreferrer"
        className="w-11 h-11 rounded-full border border-orange-200 flex items-center justify-center text-[#E8751A] hover:bg-orange-50 transition-all duration-300 cursor-pointer"
    >
        ...
        <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                ...
                <div id="contactform" className="bg-white rounded-[24px] p-8 md:p-10 border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Status UI (Kept from your logic) */}
                        {status === "success" && (
