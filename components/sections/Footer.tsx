...
export function Footer() {
    return (
        <footer className="bg-[#121212] pb-10 border-white/5 font-sans">

            {/* MAIN CONTAINER */}
            <div className="mx-auto max-w-[1280px] px-6 md:px-12 flex flex-col gap-16">

{/* --- TOP CTA SECTION WITH FULL WIDTH BLURRED BACKGROUND --- */}
<div className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden mb-12 bg-[#1B1C1E]">
    {/* The Blurred Background Layer */}
    <div 
        className="absolute inset-0 z-0 bg-cover bg-center scale-110 blur-sm brightness-50"
        style={{ backgroundImage: "url('/TSC 3.jpg')" }} 
    />

    {/* The Content */}
    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-b border-white/10 p-8 md:p-16">
    ...
    lives and advance the Gospel with integrity.
        ...
        <Link href="/give"> 
            <button className="bg-[#E8751A] text-white font-bold px-8 py-3.5 rounded-full transition-transform duration-300 hover:scale-105 active:scale-95 cursor-pointer text-[15px] shadow-2xl">
                Support the Work
            </button>
        </Link>
    </div>
                        ...
                        <div className="bg-[#1F1F1F] rounded-[16px] p-8 flex flex-col gap-6 h-full border border-white/5">
                            ...
                            <div className="flex flex-col gap-4 mt-2">
                                ...
                                <div className="flex items-center gap-4 text-white group">
                                    <div className="w-10 h-10 rounded-full bg-[#E8751A] flex items-center justify-center shrink-0 group-hover:bg-[#E8A020] transition-colors">
                            ...
                            <a href="https://www.youtube.com/@truesalvation6136" target="_blank" className="text-white hover:text-[#E8A020] transition-colors">
                                ...
                                <a href="https://www.instagram.com/truesalvationchurch/" target="_blank" className="text-white hover:text-[#E8A020] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                ...
                                <a href="https://www.tiktok.com/@truesalvationchurch" target="_blank" className="text-white hover:text-[#E8A020] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                        <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
                                    </svg>
                                </a>
                                <a href="https://whatsapp.com/channel/0029Vb6WTTkBVJl7PUUJpC41" target="_blank" className="text-white hover:text-[#E8A020] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                ...
                                <a href="https://x.com/truesalvationc?s=20" target="_blank" className="text-white hover:text-[#E8A020] transition-colors">
        ...
        <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                        ...
                        <nav className="flex flex-col gap-3">
                            {FOOTER_LINKS.map((link) => (
                                <Link
                                    key={link.label}
                                    href={link.href}
                                    className="text-[#FFFFFF]/70 hover:text-[#E8A020] transition-colors text-[15px] font-medium"
                                >
                                    {link.label}
                                </Link>
                            ))}
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6 pt-2">
                        ...
                        <div className="flex flex-col gap-4 text-[#FFFFFF]/80 text-[15px] leading-[1.6]">
                            ...
                            <p>
                                <strong className="text-white font-bold">Saturday:</strong> Bring Your Special Offering To Buid For God And Meet The Apostle Privately In His Office Or Via Zoom | 11:00 – 16:00 EAT
                            </p>
                            <p>
